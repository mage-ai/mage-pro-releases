...
### Pipeline authoring, graph, and editor experience
  ...
  * **Understand pipeline lineage and relationships:** Add Mage Pro lineage hooks with project opt-in, no-Postgres relationship projection, clearer relationship labels, graph open-route fixes, and dependency metadata for dynamic children.
