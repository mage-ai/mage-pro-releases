...
- **Data exploration:** Introduces a Data Explorer entrypoint, exploration UI for existing connections, virtual preview tables, Parquet and remote SQL preview adapters, lineage response handling, and improved row-count behavior.
...
- **Product updates and navigation:** Adds the product updates page, routes the app home experience into AI chat, improves post-login pipeline loading, and stabilizes header breadcrumb navigation.
